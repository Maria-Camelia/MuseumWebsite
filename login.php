        ...
        <div class="wrapper">
            <form action="login_process.php" method="post">
                ...
                <div class="input-box">
                    ...
                    <input type="text" placeholder="Introdu email-ul aici" class="txt" name="Email" required>
                </div>
                <div class="input-box">
                    <input type="Password" name="Password" placeholder="Introdu parola aici" class="txt" name="Password"
                        required>
                    <i class="bi bi-lock-fill"></i>
                </div>
                <p class="link">Nu ai cont?<br>
                    <a href="register.php">Înregistrează-te</a>
                </p>
                <button type="submit" class="btn btn-warning" name="btn-login" id="button_log">Autentificare</button>
            </form>
        </div>
