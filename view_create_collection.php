...
<body>
    <div class="main">
        ...
        <div class="register2">
            <form action="create_collection.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="title" class="form-label">Titlu colecție</label>
                    <input class="form-control" name="collectionTitle" type="text" placeholder="" aria-label="default input example">
                </div>
                <div class="mb-3">
                    <label for="description" class="form-label">Descriere colecție</label>
                    <textarea class="form-control" name="collectionDescription" id="exampleFormControlTextarea1" rows="3"></textarea>
                </div>
                <div class="mb-3">
                    <label for="formFile" class="form-label">Imagine coperta</label>
                    <input class="form-control" name="collectionCoverImage" type="file" id="formFile">
                </div>
                <div class="imageUploadContainer">
                    <div class="mb-3">
                        <label for="formFileMultiple" class="form-label">Element colecție</label>
                        <input class="form-control" type="file" id="formFileMultiple" name="elementImages[]" accept="image/">

                        <label for="element-title" class="form-label">Titlu element</label>
                        <input class="form-control" type="text" placeholder="" aria-label="default input" name="elementTitles[]">

                        <label for="element-description" class="form-label">Descriere element</label>
                        <input class="form-control" type="text" placeholder="" aria-label="default input" name="elementDescriptions[]">
                    </div>
                </div>
