    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <table id="productTable" class="table table-dark table-hover">
                <thead>
                    <tr >
                        <th scope="col" colspan="1">NUME</th>
                        <th scope="col" colspan="1">NUMAR DE TELEFON</th>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <th><a class="btn btn-primary" href="delete_users.php?ID=<?php echo $row["ID"];?>">Sterge</a></th>
                    </tr> 
                <?php
                $i++;           
                }
